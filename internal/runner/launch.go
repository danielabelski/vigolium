...
type LaunchParams struct {
	...
	// behavior as `vigolium scan-url` without --project.
	ProjectUUID string
	...
	// ConfigPath overrides the path to vigolium-configs.yaml. Empty =
	...
	// comma-separated syntax `vigolium scan --only` accepts (e.g.
