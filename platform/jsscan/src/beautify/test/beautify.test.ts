...
describe('jsscan() with beautify option', () => {
  test('emits a beautified result alongside extracted requests', async () => {
    const res = await jsscan(WEBPACK5, { beautify: true });
