...
func TestExtensionScanWithExtraScript(t *testing.T) {
	...
	// default ("~/.vigolium/extensions/") would load whatever the developer's
	// `vigolium init` bootstrapped there — including the AI presets
	// (ai_false_positive_filter.js etc.) that call vigolium.agent. With no LLM
